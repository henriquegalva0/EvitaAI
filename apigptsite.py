...
# LER TXT COM PROMT
with open("promtgptsite.txt", "r", encoding="utf8") as arcpromtgpt:
...
def apichatgptsite(valores):
    ...
    clas='Site Pendente'
    domi='Aqui forneceremos dados a respeito da notabilidade do site'
    ...
    response = client.responses.create(
        ...
        input=[
            ...
            "content": [
                {
                "type": "input_text",
                "text": f"{valores[0]}" # VARIAVEL QUE ESTOU REQUISITANDO NA FUNÇÃO
                }
            ]
            }
        ],
    ...
    if len(retornolinha)<4 and len(valores)>0: # ISSO LÊ QUALQUER RESPOSTA QUEBRADA OU QUE SEJA "0" DEFINIR AS VARIÁVEIS
